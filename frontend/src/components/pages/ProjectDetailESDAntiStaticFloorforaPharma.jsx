...
class ProjectDetailESDAntiStaticFloorforaPharma extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headers: [
      ...
      banners: [
        {
          ...
          titlelink: "Projects ",
          border: "|",
          name: "ESD Anti Static Floor for a Pharma",
          heading: "",
        },
      ],
    };
...
export default ProjectDetailESDAntiStaticFloorforaPharma;
