...
import {
  ContentProject,
  ContentProjectAadhiTapeSolutions,
  RelateProject,
  Sidebar,
  SidebarAadhiTapeSolutions,
} from "../layouts/project";

class ProjectDetailAadhiTapeSolutions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headers: [
...
export default ProjectDetailAadhiTapeSolutions;
