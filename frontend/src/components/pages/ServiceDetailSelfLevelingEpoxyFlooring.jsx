...
import {
  Sidebar,
  SidebarSelfLevelingEpoxyFlooring,
  SiteContent,
  SiteContentSelfLevelingEpoxyFlooring,
} from "../layouts/services/index";

class ServiceDetailSelfLevelingEpoxyFlooring extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headers: [
...
export default ServiceDetailSelfLevelingEpoxyFlooring;
