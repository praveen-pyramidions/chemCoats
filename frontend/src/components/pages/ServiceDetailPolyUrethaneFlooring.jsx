...
import {
  SidebarPolyUrethaneFlooring,
  SiteContentPolyUrethaneFlooring,
} from "../layouts/services/index";

class ServiceDetailPolyUrethaneFlooring extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headers: [
...
export default ServiceDetailPolyUrethaneFlooring;
