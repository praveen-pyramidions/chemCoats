...
import {
  SidebarDiElecricFlooring,
  SiteContentDiElecricFlooring,
} from "../layouts/services/index";

class ServiceDetailDiElecricFlooring extends Component {
  constructor(props) {
    super(props);
    this.state = {
      headers: [
...
export default ServiceDetailDiElecricFlooring;
