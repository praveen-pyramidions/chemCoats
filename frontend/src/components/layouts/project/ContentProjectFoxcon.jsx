      ...
      <div className="detail-gallery">
        ...
        <div className="flat-content-wrap style-3 clearfix">
          ...
          <p className="margin-top-28">
            ...
            devices. */}
            Since Foxconn, one of the biggest electronic manufacturing plants
            (EMFs) around the world, has created electrostatic discharge (ESD)
            zones for all its plant locations to protect the electronic devices
            and to keep the production processes and technological progress
            going, this paper describes the newest research on the effects of
            ESD on the performance of neural networks. A noteworthy project
            included the implementation of 58,104 sq ft of dedicated ESD
            flooring, which represents a complete static control solution in an
            industrial production line. The ground surface was deliberately
            chosen to be in accordance with the stringent requirements of the
            electronic component fabrication industry, in which a spurious
            electrostatic discharge can lead to irreversible damage to the
            delicate devices.
          </p>
          <p>
            ...
            In order to guarantee the utility of the floor, Foxconn has a very
            strict quality assurance workflow with third-party inspection at
            each stage of the workflow. Such tests were performed in order to
            verify, at the same level of resistance, that the floor gives to the
            accumulated static discharge a sufficiently strong protection.
            Testing of the body at each step of the process, from the earliest
            design to material selection, through installation and
            commissioning, ensured that the floor satisfied stringent standards
