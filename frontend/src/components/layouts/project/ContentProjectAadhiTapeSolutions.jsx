...
class ContentProjectAadhiTapeSolutions extends Component {
  render() {
    return (
      <div className="detail-gallery">
        <Helmet>
          ...
          <meta
            name="description"
            content="The 3M tape-cutting unit faced a significant challenge in maintaining the quality and effectiveness of their adhesive products due to the accumulation of dust on the floor."
          />
          <meta name="author" content="Your Company Name" />
          <meta name="robots" content="index, follow" />
          <link
            rel="canonical"
            href=" https://www.chemcoats.com/aadhitapesolutions"
          />
        </Helmet>
        <div
          ...
          <div className="owl-carousel owl-theme">
            <div className="gallery-item">
              <div className="inner">
                <div className="thumb">
                  <img
                    src="assets/img/project\AADHI-TAPE-SOLUTIONS/firstImage.jpeg"
                    alt="AADHI-TAPE-SOLUTIONS"
                    title="AADHI-TAPE-SOLUTIONS"
                  />
                </div>
              </div>
            </div>
            <div className="gallery-item">
              <div className="inner">
                <div className="thumb">
                  <img
                    src="assets/img/project/AADHI-TAPE-SOLUTIONS/WhatsApp-Image-2023-11-14-at-7.27.35-PM-qfopk1vxvji1aygmt1iya2w4qygjbpbaq0v7mvttno.jpeg"
                    alt="AADHI-TAPE-SOLUTIONS"
                    title="AADHI-TAPE-SOLUTIONS"
                  />
                </div>
            ...
            <div className="gallery-item">
              <div className="inner">
                <div className="thumb">
                  <img
                    src="assets/img/project/AADHI-TAPE-SOLUTIONS/access-floors21-qfopiawr5n3tp3040say50s8y52xzzda5d5ohcf78k.png"
                    alt="AADHI-TAPE-SOLUTIONS"
                    title="AADHI-TAPE-SOLUTIONS"
                  />
                </div>
        ...
        <div className="flat-content-wrap style-3 clearfix">
          ...
          <p className="margin-top-28">
            ...
            impacting the adhesive properties of the tape, causing operational
...
export default ContentProjectAadhiTapeSolutions;
