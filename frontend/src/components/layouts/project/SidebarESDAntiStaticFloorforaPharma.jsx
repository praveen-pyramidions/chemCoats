...
class SidebarESDAntiStaticFloorforaPharma extends Component {
  render() {
    return (
      <div className="detail-info">
        <div className="content-info">
          <div className="themesflat-headings style-2 clearfix">
            <h2 className="heading line-height-62">ESD Anti Static Floor</h2>
...
export default SidebarESDAntiStaticFloorforaPharma;
