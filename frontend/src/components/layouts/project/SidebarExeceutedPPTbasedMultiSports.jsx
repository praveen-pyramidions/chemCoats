...
class SidebarExeceutedPPTbasedMultiSports extends Component {
  render() {
    return (
      <div className="detail-info">
        <div className="content-info">
          <div className="themesflat-headings style-2 clearfix">
            <h1 className="heading line-height-62">
              PPT-based multi-sports court
            </h1>
...
export default SidebarExeceutedPPTbasedMultiSports;
