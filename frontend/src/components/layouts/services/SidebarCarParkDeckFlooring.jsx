...
class SidebarCarParkDeckFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
            ...
            <div className="inner">
              <ul className="list-wrap">
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Structural Integrity</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Corrosion Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Waterproofing</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Skid Resistance</span>
                  </Link>
                </li>
                {/* <li className="list-item">
                  <Link to="#">
...
export default SidebarCarParkDeckFlooring;
