...
class SidebarHeavyDutyEpoxyFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
          ...
          <div className="widget widget_list">
            ...
            <div className="inner">
              <ul className="list-wrap">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Superior Chemical Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Abrasion Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Long-Lasting Performance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Thermal and Heat Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Exceptional Adhesion to Substrates
                    </span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Customizable Thickness</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Vibrant, High-Gloss or Matte Finish
                    </span>
                  </Link>
                </li>
              </ul>
...
export default SidebarHeavyDutyEpoxyFlooring;
