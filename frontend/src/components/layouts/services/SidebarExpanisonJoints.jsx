...
class SidebarExpanisonJoints extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
          ...
          <div className="widget widget_list">
            ...
            <div className="inner">
              <ul className="list-wrap">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Prevents Cracking and Stress</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Enhances Durability</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Thermal and Elastic Performance
                    </span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Absorbs Vibrations and Impacts</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Prevents Displacement</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Reduces Maintenance Costs</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Improves Safety</span>
                  </Link>
                </li>
              </ul>
            </div>
...
export default SidebarExpanisonJoints;
