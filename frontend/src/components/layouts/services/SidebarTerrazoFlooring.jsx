...
class SidebarTerrazoFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
            ...
            <div className="inner">
              <ul className="list-wrap">
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Exceptional Durability</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Timeless Aesthetic Appeal</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Unparalleled Customization</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Eco-Friendly and Sustainable</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Non-Slip Surface</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Heat and Fire Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Low Maintenance Requirements</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Seamless, Hygienic Surface</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Adaptable Thickness and Installation
                    </span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Weather and Stain Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Enhanced Longevity</span>
                  </Link>
                </li>
              </ul>
            </div>
...
export default SidebarTerrazoFlooring;
