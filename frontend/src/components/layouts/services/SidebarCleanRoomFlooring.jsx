...
class SidebarCleanRoomFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
            ...
            <div className="inner">
              <ul className="list-wrap">
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Particle Emission Control</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Seamless Surfaces</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Anti-Slip Properties</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Airflow Management</span>
                  </Link>
                </li>
                {/* <li className="list-item">
                  <Link to="#">
...
export default SidebarCleanRoomFlooring;
