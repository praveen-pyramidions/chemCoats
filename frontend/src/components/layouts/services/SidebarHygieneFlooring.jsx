...
class SidebarHygieneFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
          ...
          <div className="widget widget_list">
            ...
            <div className="inner">
              <ul className="list-wrap">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Superior Cleanability</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Slip-Resistant Options</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Moisture and Stain Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Anti-Microbial Properties</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Durable and Impact-Resistant</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Thermal and Fire Resistance</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Customizable Slip Grades</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Eco-Friendly Materials</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Fast Installation and Repairs</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Odor and Stain Neutrality</span>
                  </Link>
                </li>
              </ul>
            </div>
...
export default SidebarHygieneFlooring;
