...
class SiteContentHeavyDutyEpoxyFlooring extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabs: [
    ...
    return (
      <div id="site-content" className="site-content clearfix">
        <Helmet>
          ...
          <meta
            name="description"
            content="Heavy Duty Industrial Flooring offers exceptional durability and resistance to wear, chemicals, and heavy loads. Ideal for factories, warehouses, and manufacturing facilities, it provides a long-lasting, low-maintenance surface for high-traffic, demanding environments."
          />
        ...
        <div id="inner-content" className="inner-content-wrap">
          ...
          <div className="themesflat-row equalize sm-equalize-auto clearfix">
              ...
              >
                <div className="themesflat-headings style-2 clearfix">
                  ...
                  <p className="sub-heading margin-top-33 line-height-24">
                    Heavy-duty epoxy flooring is a high-performance, resinous
                    surface coating known for its exceptional durability and
                    chemical resistance, making it suitable for industrial
                    environments with demanding requirements
                  </p>
                </div>
              </div>
              <div
            ...
            <div className="span_1_of_6 half-background style-2">
              <img
                src="assets/img/ServicePage/0-1.jpg"
          ...
          <div className="flat-content-wrap style-2 clearfix">
            <div className="item" style={{ width: "100%" }}>
              <div className="inner">
                ...
                />
                <h5 className="title">
                  Why Heavy Duty Epoxy Flooring is important ?
                </h5>
                {/* <p>
                    ...
                    <span className="item">
                      ...
                      <span className="text">
                        <span style={{ fontWeight: "500", color: "#000" }}>
                          The Bonding Marvel : Epoxy Chemistry :{" "}
                        </span>
                        At the heart of heavy-duty epoxy flooring lies its
                        robust chemical composition. Epoxy is a thermosetting
                        polymer formed by the reaction of an epoxy resin with a
                        hardening agent. This chemical union creates a flooring
                        material that can withstand immense pressure, making it
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        {" "}
                        <span style={{ fontWeight: "500", color: "#000" }}>
                          Seamless Beauty : Uniform Surface :{" "}
                        </span>
                        Epoxy flooring leaves no room for seams or joints. It’s
                        applied as a liquid, which then cures into a solid
                        surface. This seamless quality not only looks stunning
                        but also prevents the accumulation of dirt and
                        contaminants, making maintenance a breeze.
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        {" "}
                        <span style={{ fontWeight: "500", color: "#000" }}>
                          The Tough Nut : Impact Resistance :{" "}
                        </span>
                        Heavy machinery, forklifts, and dropped tools are no
                        match for epoxy flooring. Its remarkable impact
                        resistance ensures that your floor remains pristine even
                        in the toughest industrial environments.
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        {" "}
                        <span style={{ fontWeight: "500", color: "#000" }}>
                          Armor Against Chemicals :{" "}
                        </span>
                        Epoxy flooring is like a chemical fortress for your
                        concrete surface. It can withstand exposure to a wide
                        range of chemicals without losing its luster or
                        structural integrity, making it ideal for laboratories
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        Whether it’s scorching summer heat or freezing winter
                        cold, epoxy flooring doesn’t break a sweat. Its ability
                        to endure extreme temperatures without cracking or
                        warping is a testament to its engineering brilliance.
                      </span>
                    </span>
                  </div>
                </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      In environments where cleanliness is paramount, epoxy
                      flooring shines. It’s non-porous, which means it won’t
                      absorb liquids or harbor bacteria. Hospitals,
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Slippery floors are a hazard, especially in industrial
                      settings. Epoxy flooring can be customized with anti-slip
                      additives, providing a secure footing for workers and
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring doesn’t just illuminate spaces with its
                      glossy finish; it also enhances the efficiency of
                      lighting. By reflecting light, it reduces the need for
                      additional fixtures, leading to energy savings.
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      It can be tailored to suit your style and branding, with a
                      wide array of colors and designs available.
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Investing in epoxy flooring is an investment in the
                      future. With proper maintenance, it can last for decades,
                      ensuring that your space remains visually appealing and
                      structurally sound.
                    </span>
                  </span>
                </div>
          ...
          <div className="row-services">
            <div className="container">
              <h5 className="title">Heavy Duty Epoxy Flooring Images : </h5>
              <div className="row">
          ...
          <div className="flat-content-wrap style-2 clearfix">
            <div className="item" style={{ width: "100%" }}>
              <div className="inner">
                ...
                />
                <h5 className="title">
                  Area Where Heavy Duty Epoxy Flooring is used:
                </h5>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        Epoxy flooring is extensively used in manufacturing
                        plants, factories, and industrial facilities to
                        withstand heavy machinery, foot traffic, and chemical
                        exposure
                      </span>
                    </span>
                  </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        Warehouses and distribution centers benefit from epoxy
                        flooring’s durability and ability to resist the wear and
                        tear associated with the movement of goods and equipment
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        In auto repair shops, showrooms, and aerospace
                        facilities, epoxy flooring provides an attractive and
                        durable surface that can handle the weight of vehicles
                        and resist automotive fluids
                      </span>
                    </span>
                  </div>
                </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        Epoxy flooring is a hygienic choice for food and
                        beverage processing plants, as it is easy to clean,
                        resistant to food acids, and can maintain a sterile
                        environment
                      </span>
                    </span>
                  </div>
                  ...
                  <div className="inner">
                    <span className="item">
                      ...
                      <span className="text">
                        ...
                        Hospitals, clinics, and pharmaceutical facilities use
                        epoxy flooring for its clean and seamless surface, which
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Restaurants, hotels, and commercial kitchens benefit from
                      epoxy flooring’s resistance to grease, oil, and food
                      spills, making it easy to clean and maintain
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring is often chosen for its aesthetic appeal in
                      retail stores, shopping malls, and commercial spaces,
                      where a polished and attractive floor is desired.
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring in aviation hangars provides protection
                      against heavy aircraft and chemical spills while also
                      enhancing visibility and lighting in the hangar
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring is used in horse stables and riding arenas
                      due to its durability, ease of cleaning, and non-slip
                      surface.
                    </span>
                  </span>
                </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Schools, colleges, and universities utilize epoxy flooring
                      in laboratories, gymnasiums, and high-traffic areas due to
                      its durability and low maintenance requirements
                    </span>
                  </span>
                </div>
              </div>{" "}
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring is used in sports arenas, fitness centers,
                      and recreational spaces due to its shock absorption,
                      anti-slip properties, and the ability to customize colors
                      and designs
                    </span>
                  </span>
                </div>
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Laboratories involved in pharmaceutical research and
                      development often require epoxy flooring for its chemical
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Facilities involved in electronics manufacturing use epoxy
                      flooring to protect against electrostatic discharge (ESD)
                      and provide a clean, dust-free environment
                    </span>
                  </span>
                </div>
              </div>{" "}
                ...
                <div className="inner">
                  <span className="item">
                    ...
                    <span className="text">
                      ...
                      Epoxy flooring’s resistance to corrosive chemicals makes
                      it suitable for use in chemical processing plants and
                      refineries
                    </span>
                  </span>
                </div>
...
export default SiteContentHeavyDutyEpoxyFlooring;
