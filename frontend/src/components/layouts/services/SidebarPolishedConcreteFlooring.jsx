...
class SidebarPolishedConcreteFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
          ...
          <div className="widget widget_list">
            ...
            <div className="inner">
              <ul className="list-wrap">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Sleek and Modern Aesthetic</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Cost-Effective Solution</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Non-Slip Surface Options</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Reflective, Light-Enhancing Surface
                    </span>
                  </Link>
                </li>
                <li className="list-item">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Seamless and Hygienic</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">
                      Resilience to Stains and Moisture
                    </span>
                  </Link>
                </li>
                <li className="list-item">
...
export default SidebarPolishedConcreteFlooring;
