...
class SidebarSelfLevelingEpoxyFlooring extends Component {
  render() {
    return (
      <div id="sidebar">
        <div
            ...
            <div className="inner">
              <ul className="list-wrap">
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Exceptional Flatness</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
                ...
                <li className="list-item">
                  <Link to="#">
                    <span className="text">Durability and Longevity</span>
                  </Link>
                </li>
                <li className="list-item">
                  <Link to="#">
...
export default SidebarSelfLevelingEpoxyFlooring;
