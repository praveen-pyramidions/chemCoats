...
(function ($) {
  ...
  //         options: {
  //           zoom: 10,
  //           center: [13.032316457631058, 80.20608591534472],
  //           mapTypeId: "Autora",
  ...
  var googleMap = function () {
    if ($().gmap3) {
      // Custom location data with address and coordinates
      var data = JSON.parse(
        '[{"address":"CHEM COATS, Westwell Leacon, Ashford, UK","content":""}]'
      );
      ...
      $(".themesflat-map").gmap3({
        map: {
          options: {
            ...
            center: [13.031867, 80.206043], // Use coordinates from the iframe (13.031867, 80.206043)
            mapTypeId: "Autora",
            mapTypeControlOptions: {
              mapTypeIds: [
                "Autora",
            ...
            scrollwheel: true, // Enable scrolling for the map
          },
        },
      });

      // Add marker for the custom location
      $.each(data, function (key, val) {
        $(".themesflat-map").gmap3({
          marker: {
            values: [
              {
                address: val.address,
                options: {
                  icon: "./assets/img/map/icon-map.png", // Use a custom marker icon
                },
              },
            ],
          },
